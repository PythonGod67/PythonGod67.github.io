...
export const getReviewsForListing = async (listingId, page = 1, perPage = 5) => {
    ...
    const countSnapshot = await getCountFromServer(query(reviewsRef, where('listingId', '==', listingId)));
